...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      data: [
        { name: "Empire of Osmon", viewers: 988, favourite: false, like: false, id: 1 },
        { name: "Ertugrul", viewers: 786, favourite: false, like: true, id: 2 },
        { name: "Osman", viewers: 1094, favourite: false, like: false, id: 3 },
      ],
      term: "",
      filter: "all",
    };
